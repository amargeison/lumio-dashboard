...
export default function DemoSchoolShortcut() {
  const router = useRouter()
  useEffect(() => { router.replace('/demo/schools/oakridge-primary') }, [router])
  return (
    <div style={{ backgroundColor: '#07080F', color: '#F9FAFB', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div className="text-center">
        ...
        <p className="text-sm" style={{ color: '#6B7280' }}>Loading schools demo...</p>
      </div>
    </div>
  )
}
