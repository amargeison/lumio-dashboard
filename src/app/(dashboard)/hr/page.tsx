...
export default function HRPage() {
  ...
  // ── RBAC: HR sensitive data requires director/admin ──
  const [hrUserRole, setHrUserRole] = useState(() => { try { return (typeof window !== 'undefined' ? localStorage.getItem('lumio_user_role') : null) || 'director' } catch { return 'director' } })
  useEffect(() => {
    const handler = () => setHrUserRole(localStorage.getItem('lumio_user_role') || 'director')
  ...
  const canSeeSensitiveHR = ['admin', 'director'].includes(hrUserRole)
