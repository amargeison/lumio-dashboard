  ...
  return (<div className="space-y-4">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
      <div style={CS}><h4 className="text-sm font-bold mb-4" style={{ color: G }}>Board Priorities This Quarter</h4>{[
        { name: 'Reach £50k MRR by Q3', pct: 86, owner: 'Andrew Mendoza', due: 'Sep 2026' },
        { name: 'Series A Readiness', pct: 62, owner: 'Andrew Mendoza', due: 'Dec 2026' },
        { name: 'Close PP Gap <3 months', pct: 45, owner: 'Hazel Carter', due: 'Jul 2026' },
...
function PeopleTab() {
  ...
  return (<div className="space-y-4">
    ...
    {sub === 'exec' && <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">{[
      { name: 'Andrew Mendoza', role: 'CEO', tenure: '5 years', hc: 187, okr: 86, perf: 'Exceeding', color: '#7C3AED' },
      { name: 'Hazel Carter', role: 'Marketing Director', tenure: '3 years', hc: 18, okr: 78, perf: 'Meeting', color: '#EC4899' },
      { name: 'Jen Blake', role: 'Sales Director', tenure: '2 years', hc: 28, okr: 92, perf: 'Exceeding', color: '#0D9488' },
      { name: 'Christa Bell', role: 'Operations Manager', tenure: '4 years', hc: 24, okr: 71, perf: 'Meeting', color: '#F59E0B' },
      { name: 'Dawny Hall', role: 'Support Lead', tenure: '2 years', hc: 12, okr: 68, perf: 'Meeting', color: '#6D28D9' },
      { name: 'Arron Margeison', role: 'IT Director', tenure: '5 years', hc: 8, okr: 88, perf: 'Exceeding', color: '#0EA5E9' },
