...
const MOCK_MEETINGS: Meeting[] = [
  ...
  { id: '3', title: 'Investor Update Call', time: '14:00', duration: '60 min', attendees: ['Arron Margeison'], location: 'Google Meet', type: 'call', status: 'upcoming', source: 'outlook', link: 'https://meet.google.com' },
