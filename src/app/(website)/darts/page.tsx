  ...
  return (
    <div style={{ backgroundColor: BG, color: TEXT, minHeight: '100vh' }}>
      ...
      <section style={{ minHeight: '100vh', padding: '120px 24px 80px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', maxWidth: 1200, margin: '0 auto', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap', marginBottom: 48 }}>
            <Link href="/darts/darts-demo" style={{ display: 'inline-flex', alignItems: 'center', gap: 8, padding: '18px 32px', borderRadius: 12, backgroundColor: RED, color: '#fff', fontSize: 16, fontWeight: 800, textDecoration: 'none', boxShadow: `0 20px 50px ${RED}66` }}>
              Try the demo →
            </Link>
      ...
      <section style={{ textAlign: 'center', padding: '80px 24px', background: '#07080F' }}>
        ...
        <h2 style={{ fontSize: 32, fontWeight: 800, color: '#F9FAFB', marginBottom: 12 }}>Want to be one of our first 20 darts athletes?</h2>
        ...
        <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap' }}>
          <a href="/sports-signup?sport=darts" style={{ display: 'inline-flex', padding: '16px 32px', borderRadius: 12, backgroundColor: '#dc2626', color: '#fff', fontSize: 16, fontWeight: 800, textDecoration: 'none' }}>
            Apply for founding access →
          </a>
          <a href="/darts/darts-demo" style={{ display: 'inline-flex', padding: '16px 32px', borderRadius: 12, backgroundColor: 'transparent', color: '#F9FAFB', fontSize: 16, fontWeight: 800, textDecoration: 'none', border: '1px solid #374151' }}>
            Or try the demo →
          </a>
        </div>
      </section>
