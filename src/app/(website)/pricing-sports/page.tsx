...
const SPORTS: SportPricing[] = [
  ...
  },
  {
    ...
    tiers: [
      { name: 'Essential', price: '£99', period: '/mo', bestFor: 'Steps 6-7, volunteer-run clubs', features: ['Club dashboard and AI briefing', 'Squad register and availability tracker', 'Fixture calendar and match results', 'FA compliance calendar', 'Basic financial dashboard'], ctaLabel: 'Book a demo', ctaHref: 'mailto:hello@lumiosports.com?subject=Lumio%20Sports' },
      { name: 'Club Pro', price: '£299', period: '/mo', bestFor: 'Steps 3-5 — NPL, Isthmian, Southern League', recommended: true, features: ['All Essential features, plus:', 'Player contract and wage bill tracker', 'FA Ground Grading compliance tracker', 'Whole Game System registration management', 'Sponsor pipeline — up to 20 active deals', 'Match day revenue per fixture', 'Board portal — chairman, treasurer, secretary', 'AI morning briefing with voice commands'], ctaLabel: 'Book a demo', ctaHref: 'mailto:hello@lumiosports.com?subject=Lumio%20Sports' },
      { name: 'League', price: '£499', period: '/mo', bestFor: 'National League North/South and ambitious Step 3', features: ['All Club Pro features, plus:', 'Scouting module and opposition analysis', 'Full commercial pipeline with activation', 'Johan Sports integration', 'Dedicated account manager', 'FA Ground Grading gap analysis'], ctaLabel: 'Talk to us', ctaHref: 'mailto:hello@lumiosports.com?subject=Lumio%20Sports' },
    ],
  ...
  },
  {
    ...
    tiers: [
      { name: 'Tour', price: '£299', period: '/mo', bestFor: 'ATP/WTA ranked players, full team', recommended: true, features: ['ATP/WTA ranking — points expiry calendar', 'Race to Turin/Fort Worth tracker', 'Surface win rate breakdown', 'H2H records and opponent scouting', 'Lumio Vision — match & serve analysis', 'Lumio Wear — load monitoring across surfaces', 'Sponsorship manager', 'Prize money ledger and tax tracker', 'AI morning briefing — 4 role views', 'Physio and recovery dashboard', 'Up to 6 team accounts'], ctaLabel: 'Book a demo', ctaHref: 'mailto:hello@lumiosports.com?subject=Lumio%20Sports' },
      { name: 'Elite', price: '£599', period: '/mo', bestFor: 'Top 100 players with full management', features: ['All Tour features, plus:', 'Advanced opposition analysis packs', 'Full financial planning — career projection', 'Lumio Health — injury & rehab tracking', 'Lumio Scout — opponent intelligence', 'Athlete content and social suite', 'Priority account manager', 'Custom integrations'], ctaLabel: 'Talk to us', ctaHref: 'mailto:hello@lumiosports.com?subject=Lumio%20Sports' },
    ],
  ...
  },
  {
    ...
    tiers: [
      { name: 'Tour', price: '£299', period: '/mo', bestFor: 'DP World and PGA Tour professionals', recommended: true, features: ['OWGR tracker with points forecaster', 'Race to Dubai and FedExCup standings', 'Strokes Gained deep-dive (4 categories)', 'Course fit AI across 47+ venues', 'Lumio Vision — swing capture & analysis', 'Lumio Range — practice & shot data', 'Caddie workflow dashboard', 'Sponsorship manager', 'Prize money ledger and tax tracker', 'AI morning briefing — 4 role views', 'Up to 6 team accounts'], ctaLabel: 'Book a demo', ctaHref: 'mailto:hello@lumiosports.com?subject=Lumio%20Sports' },
      { name: 'Elite', price: '£599', period: '/mo', bestFor: 'Top 50 OWGR with full management', features: ['All Tour features, plus:', 'Advanced tournament prep packs', 'Full career financial planning', 'Lumio Wear — physical conditioning', 'Lumio Trace — full performance suite', 'Athlete content tracker', 'Priority account manager'], ctaLabel: 'Talk to us', ctaHref: 'mailto:hello@lumiosports.com?subject=Lumio%20Sports' },
    ],
  ...
  },
  {
    ...
    tiers: [
      { name: 'Tour', price: '£149', period: '/mo', bestFor: 'PDC tour card holders and Challenge Tour', recommended: true, features: ['Order of Merit + Tour Card Monitor', 'Merit Forecaster (round-by-round simulator)', 'Performance Rating + dartboard heatmap', 'Pressure Analysis (deciding-leg gap)', 'Equipment Setup tracker (Supabase backed)', 'Lumio Vision — throw analytics & checkout patterns', 'Lumio Wear — fitness & recovery tracking', 'Match Prep + AI tactical briefing', 'Practice Games (8 tracked games)', 'Player Onboarding wizard', 'Up to 3 team accounts'], ctaLabel: 'Book a demo', ctaHref: 'mailto:hello@lumiosports.com?subject=Lumio%20Sports' },
      { name: 'Elite', price: '£299', period: '/mo', bestFor: 'Top 16 PDC players', features: ['All Tour features, plus:', 'Lumio Live Scoring, PDC Live Data and Scolia integrations', 'Premier League + World Series trackers', 'Lumio Trace — full tournament & financial planning', 'Fan Engagement hub across 4 social platforms', 'Threaded Team Comms with full team', 'Sponsorship pipeline + Exhibition Manager', 'Priority account manager'], ctaLabel: 'Talk to us', ctaHref: 'mailto:hello@lumiosports.com?subject=Lumio%20Sports' },
    ],
  ...
  },
  {
    ...
    tiers: [
      { name: 'Pro', price: '£199', period: '/mo', bestFor: 'British/European champions and world contenders', recommended: true, features: ['Purse simulator — exact take-home before signing', 'World rankings — WBC, WBA, WBO, IBF, Zuffa', 'Multi-jurisdiction tax — UK, USA, Saudi, UAE, Germany', 'Fight camp planner — 8-12 week structured', 'Weight and cut tracker — daily log', 'Lumio GPS — in-ring corner beacons, footwork & position tracking', 'Lumio Wear — weight cut & conditioning', 'Recovery and HRV monitoring', 'Contract intelligence — Zuffa vs Matchroom', 'Medical record and injury log', 'AI morning briefing — 4 role views', 'Up to 6 team accounts'], ctaLabel: 'Book a demo', ctaHref: 'mailto:hello@lumiosports.com?subject=Lumio%20Sports' },
      { name: 'Elite', price: '£399', period: '/mo', bestFor: 'World champions and top 5 contenders', features: ['All Pro features, plus:', 'Full promotional pipeline', 'Mandatory challenger pathway tracking', 'Lumio Health — concussion & medical audit', 'Lumio Vision — opponent fight analysis', 'Athlete content and media suite', 'Full commercial pipeline', 'Priority account manager'], ctaLabel: 'Talk to us', ctaHref: 'mailto:hello@lumiosports.com?subject=Lumio%20Sports' },
    ],
        ...
        <div className="max-w-2xl mx-auto text-center">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-3 mb-6">
              <Link
                href="mailto:hello@lumiosports.com?subject=Lumio%20Sports"
