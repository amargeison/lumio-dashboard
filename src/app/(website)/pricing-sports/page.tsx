...
const SPORTS: SportPricing[] = [
  {
    ...
    included: ['PlayerData GPS integration (FIFA Quality Certified)', 'AI morning briefing — voice and text', 'FA compliance calendar and deadline alerts', 'Demo pre-seeded with Oakridge FC data', '14-day free trial on Starter and Pro Club', 'UK data hosting · GDPR compliant'],
  },
  {
    ...
    tiers: [
      ...
      { name: 'League', price: '£499', period: '/mo', bestFor: 'National League North/South and ambitious Step 3', features: ['All Club Pro features, plus:', 'Scouting module and opposition analysis', 'Full commercial pipeline with activation', 'PlayerData GPS integration', 'Dedicated account manager', 'FA Ground Grading gap analysis'], ctaLabel: 'Talk to us', ctaHref: '/contact' },
    ],
