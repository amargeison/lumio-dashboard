...
const FEATURES: Array<{ icon: string; title: string; desc: string }> = [
  ...
  { icon: '⚽', title: 'GPS Load Monitoring', desc: "Johan Sports vest integration. Pitch heatmaps, ACWR load monitoring, training load planner with injury risk flags, and per-player readiness scores every morning before training." },
...
const PRICING = [
  ...
  { name: 'Elite', price: '£499/mo', features: ['Everything in Professional', 'Johan Sports direct API', 'Lumio Scout video integration', 'Lumio Data feed', 'AI Club Comparison Analysis', 'White-label club branding', 'Unlimited staff accounts', 'Priority support'] },
  ...
  return (
    <div style={{ backgroundColor: BG, color: TEXT, minHeight: '100vh' }}>
      ...
      <Spotlight
        ...
        body="Johan Sports vests plug directly into the platform. Every training session and match generates a pitch heatmap, ACWR load score, and injury risk flag per player. The AI post-session analysis tells you who to rest and who can go harder — before you write tomorrow's session plan."
