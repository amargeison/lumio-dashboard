  ...
  return (
    <div style={{ backgroundColor: '#07080F', color: '#F9FAFB' }}>
      ...
      <section style={{ backgroundColor: '#07080F' }} className="py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-12">
            <p className="text-xs font-semibold uppercase tracking-widest mb-4" style={{ color: '#d97706' }}>Social Proof</p>
            <h2 className="text-4xl font-black" style={{ color: '#F9FAFB' }}>Trusted by Grassroots Clubs</h2>
          </div>
          <div className="max-w-3xl">
            <div className="rounded-2xl p-7 flex flex-col" style={{ backgroundColor: '#111318', border: '1px solid #1F2937' }}>
              ...
              <p className="text-sm leading-relaxed italic mb-6 flex-1" style={{ color: '#D1D5DB' }}>
                &ldquo;We used to spend an hour every Friday night chasing people for availability. Now it takes five minutes and everyone knows where to be.&rdquo;
              </p>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-semibold" style={{ color: '#F9FAFB' }}>Sunday league manager</p>
                  <p className="text-xs" style={{ color: '#6B7280' }}>West Yorkshire</p>
                </div>
              </div>
            </div>
          </div>
