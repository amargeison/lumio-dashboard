  ...
  return (
    <MockupFrame>
      ...
      <div style={{ backgroundColor: 'rgba(31,111,204,0.12)', border: `1px solid ${PURPLE}55`, borderRadius: 8, padding: '8px 10px', fontSize: 9, color: TEXT, lineHeight: 1.5 }}>
        ✨ Auto-clipped into highlights, linked to the right player, and pushed to their mobile app — you approve each clip before anyone sees it.
      </div>
    </MockupFrame>
  )
}
    ...
    <div style={{ backgroundColor: BG, color: TEXT, minHeight: '100vh' }}>
      ...
      <section style={{ padding: '128px 24px 64px', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', maxWidth: 1200, margin: '0 auto', textAlign: 'center' }}>
          ...
          {/* Whoever is reading this coaches SOMEBODY — four adults on a Tuesday,
              a junior squad, or sixty players across eight staff. The old version
              described an academy full of children and their parents, which reads
              as "not for you" to most of the coaches who would pay for this. */}
          <p style={{ fontSize: 20, color: MUTED, lineHeight: 1.6, maxWidth: 860, margin: '0 auto 32px' }}>
      ...
      <section id="features" style={{ padding: '96px 24px', backgroundColor: '#0A0C14' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          <h2 style={{ fontSize: 44, fontWeight: 900, color: TEXT, textAlign: 'center', marginBottom: 16, lineHeight: 1.1 }}>
            Built for the coach, whoever you coach.
          </h2>
          <p style={{ fontSize: 16, color: MUTED, textAlign: 'center', marginBottom: 56, maxWidth: 780, marginLeft: 'auto', marginRight: 'auto' }}>
            Thirteen modules that take you from the booking to the lesson to the write-up — and scale from one
            coach with a diary full of adults to an academy with juniors, camps and staff. Turn on what you use;
            the rest stays out of your way.
          </p>
