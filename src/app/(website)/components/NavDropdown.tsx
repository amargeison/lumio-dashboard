...
type Props = {
  /** Trigger label (e.g. "Football", "Tennis"). */
  label: string
  /** Dropdown items. */
  tiers: NavTier[]
  /** Item hover background — the sport accent at low alpha
   *  (e.g. 'rgba(239,68,68,0.08)' for football red). */
  accentHover: string
...
/**
 * Generic nav dropdown shared by every sport that has tiers (Football, Tennis…).
 * Behaviour and styling are identical to the original Football dropdown; only the
 * label, tiers and item-hover accent vary.
 */
