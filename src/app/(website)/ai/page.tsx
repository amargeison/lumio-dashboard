        ...
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 24 }}>
            {[
              ...
              { border: '#EC4899', sport: "Women's FC", example: '"FSR headroom is £142k. If the Adidas renewal lands at the proposed £220k bundled figure, your Relevant Revenue adjusts and headroom rises to £284k — but only if you attribute correctly."' },
