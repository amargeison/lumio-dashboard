...
const FEATURES: Array<{ icon: string; title: string; desc: string }> = [
  ...
  { icon: '🌍', title: 'Tours & Camps', desc: 'A full camp and tour builder — windows, day-by-day itineraries, squad and staff, travel and accommodation, live budgets, commercial activation and cycle / maternity / dual-reg-aware medical planning, with a one-click AI draft. Every camp and tour is a clickable plan with its own detail view, alongside a history of previous pre-seasons, camps and tours.' },
  { icon: '🎯', title: 'Matchday Operations', desc: 'The flagship operations command centre — because everything at a club revolves around match day. Nine tabs: an Overview with live readiness and a full run-of-day timeline, plus Safety & Stewarding, Pitch & Facilities, Catering & Hospitality, Media & Broadcast, Officials, Ticketing & Turnstiles, Emergency / EAP and the Post-match wrap. Interactive checklists, named contacts, timings, capacities, costs and risk flags — everything an ops manager needs in one place.' },
  { icon: '📖', title: 'AI Matchday Programme', desc: 'A full online matchday programme in one click. The AI pulls in the fixture, squads, league table and recent results, writes the chair’s welcome and manager’s notes, then lays out the opposition, line-ups, a tactical board, season charts, an academy feature, “on this day”, young-supporters and fan-zone pages — and renders a premium editorial flip-book you can share or print. Designed sponsor logos and your own photos drop straight in. Built for clubs with no design team.' },
  { icon: '🏟️', title: 'Club Operations', desc: 'The wider operations workspace — facilities & stadium status, suppliers & contracts, compliance & licensing, staffing & rota, an ops calendar and live action items. Matchday itself now has its own dedicated command centre in Matchday Operations.' },
  ...
  { icon: '🧭', title: 'Compliance Command Centre', desc: 'A single RAG view across every compliance domain — FSR headroom, salary cap, Club Licensing and Karen Carney standards — plus a master Compliance Calendar of every deadline, and dedicated workspaces for Registration & Transfers (WPLL squad registration, GBE / work permits, international clearance, intermediary disclosure), Data Protection (UK GDPR), Safeguarding Operations, Anti-Doping (UKAD / WADA), a Risk Register & Insurance and a Policy Library with staff attestations.' },
  { icon: '🌍', title: 'Player Integration', desc: 'End-to-end onboarding for international & relocating players. A live drag-and-drop welfare board, immigration & GBE, relocation & setup (housing, banking, GP, driving), family & education, language & culture and wellbeing — each player expands into a full stage checklist. No stone unturned.' },
  ...
  { icon: '🧠', title: 'Concussion Tracker', desc: 'FA Concussion Guidelines and the 6-stage GRTP protocol. Active-case timelines, squad concussion history, baseline SCAT5 records, education & training compliance and an FA-compliance audit — built around player safety.' },
  { icon: '🔋', title: 'Load & Recovery', desc: 'Daily readiness from training load (acute:chronic workload ratio), sleep and wellness, with a weekly load picture and recovery interventions — the physiological view behind selection and load management, cycle-phase aware.' },
  { icon: '🩹', title: 'Injury & Return-to-Play', desc: 'A five-phase return-to-play pathway with rehab milestones and graduated return-to-play (GRTP) clearance gates — medical and performance sign-off against objective criteria before a player is available.' },
  { icon: '💷', title: 'Finance command centre', desc: 'The full CFO suite alongside Club Finance: a Player Trading & Amortisation ledger (the number that drives FSR), Treasury, Debt & Covenants, a Payroll & Bonus ledger, Budget vs Actuals, Revenue & Receivables, Central Distributions & Prize Money, Management Accounts with a board pack, CapEx & investment appraisal, and multi-year Financial Planning.' },
  { icon: '🤝', title: 'Sponsorship Pipeline', desc: 'Every commercial conversation from prospect to signed — stages, value, probability, renewals and owner — feeding the board view and FSR revenue attribution.' },
  { icon: '🛍️', title: 'Commercial growth', desc: 'Retail & Merchandise (range, margin, bestsellers), Ticketing & Yield (pricing, demand, season-ticket renewals) and Sponsor Activation & ROI (deliverables tracking and value-in-kind) — the women’s-game commercial engine in one place.' },
  ...
  { icon: '🌍', title: 'Community & Foundation', desc: 'Foundation activity, schools and grassroots partnerships, participation numbers and social-value reporting — underpinning the Karen Carney equal-access standards.' },
]
