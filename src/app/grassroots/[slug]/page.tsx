...
import GrassrootsSendMessageModal from '@/components/football/GrassrootsSendMessageModal'
...
function GrassrootsPortalInner({ session }: { session: SportsDemoSession }) {
  ...
  return (
    <div className="flex flex-col" style={{ backgroundColor: '#07080F', color: TEXT, minHeight: '100vh', zoom: 0.9 }}>
      <Toast message={toast} />
      {sendMessageOpen && <GrassrootsSendMessageModal onClose={() => setSendMessageOpen(false)} />}
