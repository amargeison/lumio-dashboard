...
export function printBeltCertificate(player: Player, beltIndex: number) {
  ...
  const html = `<!DOCTYPE html><html><head><meta charset="utf-8"><title>${esc(belt.name)} Belt — ${esc(player.name)}</title>
  <style>
  ...
  <div class="page">
    ...
    <div style="text-align:center;padding:28mm 24mm;position:relative;max-width:170mm">
      ...
      <div style="font-family:Georgia,'Times New Roman',serif;font-size:40px;letter-spacing:.04em;margin-top:14px;color:#1a1d29">Belt Award</div>
      ...
      <div style="display:inline-flex;align-items:center;gap:14px;margin:16px 0 6px">
        ...
        <span style="font-family:Georgia,serif;font-size:34px;font-weight:700;color:#1a1d29">${esc(belt.name)} Belt</span>
      </div>
