...
export function CoachContactSettings({ T, accent }: { T: ThemeTokens; accent: AccentTokens }) {
  ...
  return (
    <div style={{ background: T.panel, border: `1px solid ${T.border}`, borderRadius: 14, padding: 20, marginBottom: 16 }}>
      ...
      <p style={{ color: T.text3, fontSize: 13, margin: '0 0 16px' }}>Your sending email and phone enable the Email and Text message channels. Your Lumio bookings are added to your connected calendar (one-way).</p>
      ...
      <div style={{ marginTop: 14 }}>
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center', marginTop: 6 }}>
          ...
          {calendar && calendar !== 'none'
            ? <span style={{ fontSize: 10, fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.05em', color: '#22C55E', background: 'rgba(34,197,94,0.12)', border: '1px solid rgba(34,197,94,0.35)', padding: '4px 10px', borderRadius: 999 }}>✓ Bookings → calendar</span>
            : null}
        </div>
      </div>
