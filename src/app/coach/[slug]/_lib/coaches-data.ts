...
export const COACHES: Coach[] = [
  ...
  { id: 'david',  name: 'David Okonkwo',   initials: 'DO', role: 'Coach',     accreditation: 'LTA Accredited Coach',          specialisms: ['Junior', 'Mini/Red'],            availability: 'Mon–Fri · afternoons',hoursPerWeek: 26, status: 'active', homeVenue: HOME },
  { id: 'elena',  name: 'Elena Petrova',   initials: 'EP', role: 'Coach',     accreditation: 'LTA Accredited Coach',          specialisms: ['Cardio', 'Adult'],               availability: 'Tue–Sun · days',      hoursPerWeek: 26, status: 'active', homeVenue: HOME },
  { id: 'jamie',  name: 'Jamie Sutton',    initials: 'JS', role: 'Coach',     accreditation: 'LTA Accredited Coach',          specialisms: ['Adult', 'Doubles'],              availability: 'Wed–Sun · days',      hoursPerWeek: 24, status: 'active', homeVenue: HOME },
  { id: 'aisha',  name: 'Aisha Khan',      initials: 'AK', role: 'Coach',     accreditation: 'LTA Accredited Coach',          specialisms: ['Junior', 'Performance'],         availability: 'Mon–Fri · days',      hoursPerWeek: 24, status: 'active', homeVenue: HOME },
  { id: 'theo',   name: 'Theo Hargreaves', initials: 'TH', role: 'Coach',     accreditation: 'LTA Accredited Coach',          specialisms: ['Performance', 'Match play'],     availability: 'Mon–Sat · days',      hoursPerWeek: 24, status: 'active', homeVenue: HOME },
  { id: 'grace',  name: 'Grace Lin',       initials: 'GL', role: 'Coach',     accreditation: 'LTA Accredited Coach',          specialisms: ['Junior', 'Mini/Red'],            availability: 'Thu–Mon · days',      hoursPerWeek: 22, status: 'active', homeVenue: HOME },
  { id: 'ben',    name: 'Ben Carter',      initials: 'BC', role: 'Assistant', accreditation: 'LTA Coaching Assistant',        specialisms: ['Mini/Red', 'Cardio'],            availability: 'Sat–Sun + eves',      hoursPerWeek: 18, status: 'active', homeVenue: HOME },
  { id: 'nadia',  name: 'Nadia Rashid',    initials: 'NR', role: 'Assistant', accreditation: 'LTA Coaching Assistant',        specialisms: ['Junior', 'Adult'],               availability: 'Mon–Fri · eves',      hoursPerWeek: 18, status: 'active', homeVenue: HOME },
  { id: 'luca',   name: 'Luca Romano',     initials: 'LR', role: 'Assistant', accreditation: 'LTA Coaching Assistant',        specialisms: ['Mini/Red', 'Junior'],            availability: 'Wed–Sun · days',      hoursPerWeek: 16, status: 'active', homeVenue: HOME },
  { id: 'chloe',  name: 'Chloe Foster',    initials: 'CF', role: 'Apprentice',accreditation: 'LTA Level 2 (in training)',     specialisms: ['Mini/Red'],                      availability: 'Sat–Sun',             hoursPerWeek: 12, status: 'active', homeVenue: HOME },
  { id: 'ollie',  name: 'Ollie Grant',     initials: 'OG', role: 'Apprentice',accreditation: 'LTA Level 2 (in training)',     specialisms: ['Mini/Red', 'Junior'],            availability: 'Fri–Sun',             hoursPerWeek: 12, status: 'active', homeVenue: HOME },
]
