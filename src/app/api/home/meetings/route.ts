...
export async function GET(req: NextRequest) {
  ...
  const meetings = [
    { id: '1', title: 'Client Partnership — Weekly Check-in', time: '09:00', duration: '30 min', attendees: ['Sarah M.'], location: 'Google Meet', type: 'video', status: hour > 9 ? 'done' : hour === 9 ? 'now' : 'upcoming', source: 'google', link: 'https://meet.google.com' },
