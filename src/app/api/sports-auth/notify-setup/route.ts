...
const SPORT_CREDENTIALS: Record<string, { name: string; why: string; powers: string }[]> = {
  darts: [
    ...
    { name: 'Walk-on music track + BPM', why: 'Manages broadcaster clearances across Northbridge Sport, DAZN, ITV, Crown Broadcasting', powers: 'Walk-on Music Manager, broadcaster approvals' },
