...
import NonLeagueContent, { NL_SIDEBAR_ITEMS, type NLDeptId } from '../../../demo/football-amateur/[slug]/nl-content'
  ...
  return (
    <div className="flex flex-col" style={{ backgroundColor: '#07080F', color: TEXT, height: '100vh', overflow: 'hidden' }}>
      ...
      <div className="md:hidden flex items-center px-4 py-2 shrink-0" style={{ borderBottom: `1px solid ${BORDER}` }}>
        ...
        <span className="text-sm font-semibold ml-2 truncate" style={{ color: TEXT }}>Harfield FC</span>
      </div>
          ...
          <main className="flex-1 p-4 sm:p-5">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-xs mt-0.5" style={{ color: TEXT_SEC }}>Harfield FC &middot; Northern Premier League West</p>
              </div>
            </div>
