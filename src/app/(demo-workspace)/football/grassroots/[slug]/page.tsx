...
function Sidebar({ activeDept, onSelect, open, onClose }: { activeDept: string; onSelect: (d: string) => void; open: boolean; onClose: () => void }) {
  ...
  return (
    <div className="flex flex-col" style={{ backgroundColor: '#07080F', color: TEXT, height: '100vh', overflow: 'hidden' }}>
      ...
      <div className="md:hidden flex items-center px-4 py-2 shrink-0" style={{ borderBottom: `1px solid ${BORDER}` }}>
        ...
        <span className="text-sm font-semibold ml-2 truncate" style={{ color: TEXT }}>Sunday Rovers FC</span>
      </div>

      {/* Body: sidebar + content */}
      <div className="flex flex-1 overflow-hidden">
        <Sidebar activeDept={activeDept} onSelect={(d) => setActiveDept(d as DeptId)} open={sidebarOpen} onClose={() => setSidebarOpen(false)} />
