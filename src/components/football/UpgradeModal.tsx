...
const FEATURE_NAMES: Record<string, string> = {
  ...
  gps_hardware_catapult: 'Catapult OpenField',
  gps_hardware_statsports: 'STATSports Sonra',
  opta_integration: 'Opta Integration',
  statsbomb_integration: 'StatsBomb',
  wyscout_integration: 'Wyscout',
