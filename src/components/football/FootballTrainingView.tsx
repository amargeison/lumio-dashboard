...
// Men's Pro Training — full coaching workspace.
...
// ─── Weekly session content (Oakridge FC, Championship · MD = Sunday) ──────────
const DAYS: DaySession[] = [
  {
    ...
    blocks: [
      ...
      { name: 'Video — match review', mins: 40, detail: 'Clip pack from Thornvale: pressing triggers, transition moments, set-piece review. Honest, solutions-focused.', players: 'Full squad (PM)', equipment: ['Projector', 'Clip pack'], points: ['Lead with 2 wins before corrections', 'Tie clips to this week’s theme'] },
    ],
  ...
  },
  {
    ...
    focus: 'Tactical rehearsal of the matchday plan vs a Thornvale-shaped opposition.', sessionTime: '10:00',
    ...
    blocks: [
      ...
      { name: '11v11 phase game', mins: 40, detail: 'Bench/academy set up as Thornvale (direct LW, back-post corner threat). Conditioned scoring to reward the game plan.', players: 'Full squad', equipment: ['Full goals', 'Bibs', 'Balls'], points: ['Win the ball high, score within 8 seconds', 'Double-up on their direct winger', 'Defend the back post on corners'] },
  ...
  },
  {
    ...
    blocks: [
      ...
      { name: 'Set-piece walk-through', mins: 15, detail: 'Confirm attacking corner routines and defensive assignments for Thornvale. Low intensity, high clarity.', players: 'Full squad', equipment: ['Balls', 'Mannequins', 'Cones'], points: ['Everyone knows their job', 'No new info — reinforce only'] },
    ],
  ...
  },
  {
    ...
    focus: 'Travel to Thornvale, light primer, team meeting.', sessionTime: '—',
    am: { title: 'Travel', type: 'Logistics', duration: '—', location: 'Coach to Thornvale' },
  ...
  {
    key: 'sun', day: 'Sunday', date: 'MD', mdTag: 'MD', theme: 'MATCHDAY — Thornvale United (A)', intensity: 'High',
    focus: 'Execute the plan. KO 14:00.', sessionTime: '14:00',
    am: { title: 'Pre-match warm-up', type: 'Matchday', duration: '30 min', location: 'Thornvale Stadium' },
    pm: { title: 'MATCH', type: 'Fixture', duration: '90+ min', location: 'Thornvale Stadium' },
    blocks: [
      ...
      { name: 'Match', mins: 95, detail: 'Championship fixture vs Thornvale United. Live in-game GPS + tactical tracking; HT adjustments from the analysts.', players: 'Matchday 18', equipment: ['Match kit', 'GPS vests'], points: ['Trust the press triggers', 'Win the set-piece battle', 'Stick to the game plan'] },
    ],
...
].map((p, i) => ({ ...p, createdBy: ['James Hartley (Manager)', 'Set-piece coach', 'Sports science'][i], tag: undefined }))
...
const GPS_DATA: GpsRow[] = [
  ...
  { player: 'S. Porter', pos: 'ST', distance: 9.8,  hiSpeed: 760, sprints: 26, maxSpeed: 29.8, acwr: 1.02, load: 'optimal' },
  ...
  { player: 'R. Cole',   pos: 'CAM',distance: 10.5, hiSpeed: 840, sprints: 28, maxSpeed: 30.0, acwr: 1.28, load: 'high' },
  { player: 'M. Reid',   pos: 'CB', distance: 9.4,  hiSpeed: 620, sprints: 22, maxSpeed: 28.8, acwr: 0.92, load: 'optimal' },
  { player: 'K. Osei',  pos: 'RB', distance: 10.4, hiSpeed: 820, sprints: 28, maxSpeed: 30.4, acwr: 1.06, load: 'optimal' },
  { player: 'T. Fletcher',    pos: 'LB', distance: 10.7, hiSpeed: 900, sprints: 27, maxSpeed: 30.1, acwr: 1.12, load: 'optimal' },
  { player: 'D. Webb',  pos: 'CB', distance: 9.6,  hiSpeed: 640, sprints: 19, maxSpeed: 28.2, acwr: 0.88, load: 'optimal' },
  { player: 'I. Kemp',     pos: 'CB', distance: 9.8,  hiSpeed: 700, sprints: 21, maxSpeed: 28.9, acwr: 1.41, load: 'overload' },
  { player: 'J. Hayes',    pos: 'GK', distance: 5.2,  hiSpeed: 120, sprints: 4,  maxSpeed: 24.0, acwr: 0.95, load: 'optimal' },
]
const WEEK_LOAD = [
...
const RECOVERY_FLAGS = [
  { player: 'J. Henderson', note: 'Grade 2 hamstring — RTP graded, no max sprints until MD-3', tone: C.warn },
  { player: 'B. Chen', note: 'Concussion protocol — graded return to contact, symptom-free 48h', tone: C.warn },
  { player: 'I. Kemp',   note: 'ACWR 1.41 (overload) — modify Thursday high-speed volume', tone: C.bad },
  { player: 'M. Osei', note: 'ACL RTP Phase 3 — gym + non-contact only, on-track', tone: C.blue },
]
...
export default function FootballTrainingView() {
      ...
      {tab === 'week' && (
        <div className="space-y-4">
          <div>
            ...
            <p className="text-xs" style={{ color: C.textSec }}>MD = Sunday vs Thornvale United (A) · click any day for the full session plan</p>
          </div>
