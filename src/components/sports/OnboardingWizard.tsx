      ...
      <div style={{ width: '100%', maxWidth: 560, background: '#0d1117', border: '1px solid #1F2937', borderRadius: 20, padding: 36 }}>
        ...
        {step === 5 && (<div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            <button onClick={() => setSetupType('self')} style={{ padding: 20, borderRadius: 14, textAlign: 'left', cursor: 'pointer', background: '#111318', border: `2px solid ${setupType === 'self' ? accentColor : '#1F2937'}`, transition: 'all 0.2s' }}><div style={{ fontSize: 24, marginBottom: 8 }}>🔧</div><div style={{ color: '#fff', fontSize: 15, fontWeight: 700, marginBottom: 4 }}>I&apos;ll set it up myself</div><div style={{ color: '#9CA3AF', fontSize: 13 }}>Walk through connecting your accounts and integrations now.</div></button>
          </div>
        </div>)}
