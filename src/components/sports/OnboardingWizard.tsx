...
const SPORT_CONFIG: Record<string, {
  ...
  golf: {
    ...
    step2Fields: [
      ...
      { id: 'field3', label: 'Lumio Data username', placeholder: 'Your Lumio Data handle', hint: 'Powers strokes-gained analytics — optional' },
    ],
    step3Title: 'Home airport',
    ...
    step4Options: ['Lumio Range', 'Lumio Range Pro', 'Lumio Data', 'None / Manual'],
    step4Hints: {
      'Lumio Range': '✓ Lumio Range API available — we activate this during setup',
      'Lumio Range Pro': '✓ Lumio Range Pro API available — we handle the connection for you',
      'Lumio Data': '✓ Live strokes-gained sync available',
      'None / Manual': '',
    },
  ...
  tennis: {
    ...
    step2Fields: [
      ...
      { id: 'field3', label: 'Lumio Vision username', placeholder: 'Your Lumio Vision handle (coming soon)', hint: 'Powers shot analytics and video tagging — Lumio Vision rolling out through 2026' },
    ],
    step3Title: 'Home airport',
...
export default function OnboardingWizard({ sport, accentColor, profile, onComplete }: Props) {
  ...
  if (phase === 'handoff-confirmation') {
    ...
    const stillNeed = sport === 'darts' ? [
      ...
      'Lumio Range account email',
      'Caddie name + contact',
      'Active sponsor names + contact emails',
    ] : sport === 'tennis' ? [
      'Contact phone number',
      'ATP / WTA member ID',
      'Lumio Vision account email (coming soon)',
