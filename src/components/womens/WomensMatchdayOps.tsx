...
import WomensMatchdayProgramme from './WomensMatchdayProgramme'

// ─────────────────────────────────────────────────────────────────────────
// Women's — Matchday Operations command centre.
//
...
//
// Fixture: Oakridge Women FC vs Hartwell Women · Sat 03 May 2026 · KO 14:00
//          Oakridge Stadium (Home) · WSL 2 · MD-19 · Forecast attendance 4,200.
// ─────────────────────────────────────────────────────────────────────────
...
const RUN_OF_DAY: { t: string; label: string; detail: string; tone?: Tone }[] = [
  ...
  { t: '14:00', label: 'KICK-OFF', detail: 'vs Hartwell Women · WSL 2', tone: 'bad' },
...
const KEY_CONTACTS = [
  ...
  { role: 'Referee', name: 'Laura Whitfield', phone: '—', note: 'WSL 2 panel' },
]

export default function WomensMatchdayOps({ accent = '#BE185D' }: { accent?: string }) {
    ...
    <div style={{ color: C.text }}>
      ...
      <div className="rounded-2xl p-5 mb-5" style={{ backgroundColor: C.card, border: `1px solid ${C.border}` }}>
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <div className="text-[10px] font-bold uppercase tracking-[0.18em] mb-1" style={{ color: accent }}>Match day · WSL 2 · MD-19</div>
            <div className="text-lg font-bold" style={{ color: C.text }}>Oakridge Women FC <span style={{ color: C.text3, fontWeight: 400 }}>vs</span> Hartwell Women</div>
            <div className="text-[11.5px] mt-1" style={{ color: C.text3 }}>Sat 03 May 2026 · KO 14:00 · Oakridge Stadium (Home) · Forecast attendance 4,200 / 5,000</div>
          </div>
      ...
      {tab === 'programme'  && <WomensMatchdayProgramme accent={accent} />}
  ...
  return (
    <div className="space-y-5">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <StatTile accent={accent} label="Expected attendance" value="4,200" sub="84% of 5,000 capacity" tone="info" />
...
function SafetyTab({ accent }: { accent: string }) {
  return (
    <div className="space-y-5">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <StatTile accent={accent} label="Safety certificate" value="5,000" sub="General safety cert · valid" tone="good" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        <Checklist accent={accent} title="Stewarding plan" icon={Users} items={[
          ...
          { id: 's5', label: 'Segregation / away end (×2)', meta: 'Hartwell ~120 travelling' },
  ...
  return (
    <div className="space-y-5">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <StatTile accent={accent} label="Hospitality covers" value="14 / 20" sub="12 sponsors · 2 board" tone="warn" />
        <StatTile accent={accent} label="Matchday F&B revenue" value="£6,800" sub="Forecast at 4,200 gate" tone="info" />
    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <Panel title="Officials — appointed" icon={Users} accent={accent}>
          <div className="flex flex-col gap-2">
            <Contact role="Referee · WSL 2 panel" name="Laura Whitfield" phone="—" />
  ...
  return (
    <div className="space-y-5">
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        ...
        <StatTile accent={accent} label="Forecast gate" value="4,200" sub="~1,100 on the day" tone="info" />
        <StatTile accent={accent} label="Away allocation" value="300" sub="~120 sold to Hartwell" tone="good" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        ...
        <Checklist accent={accent} title="Turnstiles & counting" icon={Users} items={[
          ...
          { id: 'tt4', label: 'Occupancy capped at 5,000', done: true, tone: 'good' },
