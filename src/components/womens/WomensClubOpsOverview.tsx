...
// Women's Club Operations — overview for the operations manager.
...
const CALENDAR: { date: string; label: string; tone: Tone }[] = [
  { date: 'Sun 03 May', label: 'Matchday — vs Hartwell Women (H), KO 14:00', tone: 'bad' },
...
export default function WomensClubOpsOverview({ accent = '#BE185D' }: { accent?: string }) {
  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3">
        <Kpi label="Matchday readiness" value={`${readinessAvg}%`} sub="vs Hartwell · Sun" icon={ClipboardCheck} color={accent} tone="warn" />
