...
const DATA: Record<string, DeptData> = {
  ...
  settings: { manager: 'Arron Margeison', size: 0, team: [], roles: [], priorities: [], budget: '—', tools: 'Lumio', okrs: '—', cadence: '—', slack: '#general' },
}
