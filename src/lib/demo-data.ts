...
export function buildDemoData(businessId: string) {
  ...
  const tasks = [
    ...
    { business_id: businessId, title: 'Update booking link in nav buttons', description: 'Currently showing placeholder URL. Replace with live meeting link.', due: 'Any time', priority: 'medium', category: 'Tech', source: 'manual', assignee: 'Priya Kapoor', done: false, overdue: false, is_demo: true },
    { business_id: businessId, title: 'Complete company registration', description: 'Required before signing any customer contracts. Submit online registration.', due: 'Any time', priority: 'high', category: 'Legal', source: 'manual', assignee: 'James Hartley', done: false, overdue: false, is_demo: true },
  ]
