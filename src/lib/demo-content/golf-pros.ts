...
export const COURSES_ROSTER: Course[] = [
  { id: 'gc-01', name: 'Ashbourne National',     location: 'Surrey, England',       design: 'Championship', greenFee: '£340 (pro rate on request)', access: 'Tour-pro rate via DP World Tour letter', amenities: ['TrackMan bays','Short-game area','Fitness centre','Accommodation'], courseRating: 76.2, slopeRating: 142, description: 'Pro rota venue. 7,312 yards off the championship tees, aggressive Bermuda greens, full tour practice facility.' },
  ...
  { id: 'gc-04', name: 'Crown Park Estate',       location: 'Kent, England',          design: 'Championship', greenFee: '£310',                   access: 'Members + tour pros',                     amenities: ['TrackMan indoor','Outdoor range','Fitness','Overnight lodges'], courseRating: 75.9, slopeRating: 141, description: 'Purpose-built pro venue. 2,700-yard practice circuit with every club tested, two full championship 18s.' },
