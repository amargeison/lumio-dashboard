...
export const DRIVING_RANGES_ROSTER: Range[] = [
  { id: 'r-01', name: 'Crown Park Range',           location: 'Kent, England',          facilities: ['Covered bays','Outdoor turf','Short-game area','Putting lab'], rangeBays: 12, coachOnSite: true,  hourlyRate: '£45/hr',  access: 'Tour-pro rate with letter', description: '12 launch-monitor bays, covered and heated. On-site putting lab with Capto/Quintic. PGA master coach (Pete Mitchum) available by appointment.' },
  { id: 'r-02', name: 'Ashbourne Performance Lab',  location: 'Surrey, England',        facilities: ['Indoor bays','Outdoor turf','Short-game','3D motion'],         rangeBays: 8,  coachOnSite: true,  hourlyRate: '£60/hr',  access: 'By appointment',            description: 'Elite pro training facility. GEARS 3D motion capture, force plates, pressure mats. Popular with Ryder Cup pathway players.' },
  { id: 'r-03', name: 'Meridian Range — Algarve',   location: 'Albufeira, Portugal',     facilities: ['Covered bays','Grass tee','Short-game','Pool'],                rangeBays: 6,  coachOnSite: false, hourlyRate: '€35/hr',  access: 'Open booking',              description: 'Winter-base staple. Grass teeing surface year-round, on-site short-game complex with multiple bunker types.' },
  { id: 'r-04', name: 'Havenbrook Practice Ground', location: 'Perthshire, Scotland',    facilities: ['Grass tee','Sheltered bays','Putting green'],                  rangeBays: 4,  coachOnSite: false, hourlyRate: '£25/hr',  access: 'Open booking',              description: 'Quiet parkland range. Grass teeing 9 months a year, sheltered winter bays. No frills, good tempo-work venue.' },
  { id: 'r-05', name: 'Suncrest Sports Park',       location: 'Phoenix, Arizona',        facilities: ['Outdoor bays','Short-game','Fitness','Putting complex'],       rangeBays: 10, coachOnSite: true,  hourlyRate: '$55/hr',  access: 'Open booking',              description: 'Winter off-season destination. Warm-weather outdoor range, elite short-game area replicating US major venues.' },
  { id: 'r-06', name: 'Northbridge Performance',    location: 'Orlando, Florida',        facilities: ['Indoor + outdoor','3D capture','Putting lab','Nutritionist'], rangeBays: 14, coachOnSite: true,  hourlyRate: '$75/hr',  access: 'Pro-only by referral',      description: 'Full-service pro performance centre. Swing coaches, nutritionists, physios all in-house. Used by 30+ tour players.' },
  { id: 'r-07', name: 'Weybrook Hall Range',        location: 'Hertfordshire, England',  facilities: ['Covered bays','Grass tee','Short-game'],                       rangeBays: 5,  coachOnSite: false, hourlyRate: '£30/hr',  access: 'Members + guests',           description: '40 min from London. Reliable mid-budget range, grass teeing half the year, good putting green.' },
  { id: 'r-08', name: 'Kinrossie Grange Range',     location: 'Fife, Scotland',          facilities: ['Covered bays','Grass tee','Chipping area','Bunker complex'],   rangeBays: 6,  coachOnSite: false, hourlyRate: '£28/hr',  access: 'Open booking',              description: 'Adjacent to Kinrossie GC. Links-style practice conditions, firm ground year-round, open most of the year.' },
  { id: 'r-09', name: 'Valmora Swing Lab',          location: 'Algarve, Portugal',       facilities: ['Indoor bays','3D motion','Launch monitor','Coach'],            rangeBays: 10, coachOnSite: true,  hourlyRate: '€55/hr',  access: 'Open booking',              description: 'Performance-first indoor facility. Full launch-monitor data, GEARS motion capture, resident swing coach Pedro Silva.' },
  { id: 'r-10', name: 'Redcliff Links Range',       location: 'County Down, N. Ireland', facilities: ['Grass tee','Sheltered bays','Short-game','Bunker complex'],    rangeBays: 3,  coachOnSite: false, hourlyRate: '£22/hr',  access: 'Open booking',              description: 'Seaside links range. Exposed to Irish Sea winds — ideal for ball-flight control and trajectory work.' },
];
