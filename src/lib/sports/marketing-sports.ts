...
export const SPORTS: Sport[] = [
  ...
  { id: 'grassroots', label: 'Grassroots',      logo: '/football_logo.png',  href: '/grassroots/sunday-rovers-fc',         accent: '#84cc16', desc: 'AI team selection, subs collection, safeguarding, parent portal',               available: false },
  ...
  { id: 'rugby',      label: 'Rugby',           logo: '/rugby_logo.png',     href: '/rugby/hartfield',                     accent: '#f97316', desc: 'Salary cap, GPS, pre-season camp, set pieces, board suite',                     available: false },
  { id: 'tennis',     label: 'Tennis',          logo: '/tennis_logo.png',    href: '/tennis/demo',                         accent: '#a855f7', desc: 'ATP/WTA rankings, match prep, AI briefing, GPS heatmaps',                        available: false },
  { id: 'boxing',     label: 'Boxing',          logo: '/boxing_logo.png',    href: '/boxing/demo',                         accent: '#ef4444', desc: 'Fight camp, weight tracker, opponent scout, purse simulator',                   available: false },
  { id: 'golf',       label: 'Golf',            logo: '/golf_logo.png',      href: '/golf/demo',                           accent: '#EAB308', desc: 'OWGR ranking, strokes gained, course fit, caddie hub',                          available: false },
  { id: 'darts',      label: 'Darts',           logo: '/darts_logo.png',     href: '/darts/demo',                          accent: '#22c55e', desc: 'PDC rankings, practice tracker, match prep, opponent intel',                    available: false },
]
